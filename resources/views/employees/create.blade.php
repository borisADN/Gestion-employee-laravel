...
@section('content')
    ...
    <div class="row g-4 settings-section">
        <div class="col-12 col-md-4">
            ...
            <div class="section-intro">Ajouter ici Un Nouvel employee</div>
        </div>
                ...
                <div class="app-card-body">
                    <form class="settings-form" method="POST" action="{{ route('employee.store') }}"> 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-2" placeholder="Entrez le prenom " name="last_name" value="{{ old('last_name') }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-3"
                              name="phone" placeholder="entrez le contact"value="{{ old('phone') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="setting-input-3"
                              name="montant_journalier" placeholder="entrez le montant journalier" value="{{ old('montant_journalier') }}">
                        </div>
