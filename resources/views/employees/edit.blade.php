...
<div class="row g-4 settings-section">
    <div class="col-12 col-md-4">
        ...
        <div class="section-intro">editer un employee</div>
    </div>
    <div class="col-12 col-md-8">
        <div class="app-card app-card-settings shadow-sm p-4">

            <div class="app-card-body">
                <form class="settings-form" method="POST" action="{{ route('employee.update',$employee->id) }}"> 
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="setting-input-1" placeholder="Entrez le nom " name="first_name"
                            required value="{{ $employee->nom}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="setting-input-2" placeholder="Entrez le prenom " name="last_name" value="{{ $employee->prenom}}">
                    </div>
                    <div class="mb-3">
                        <label for="setting-input-3" class="form-label">Email</label>
                        <input type="email" class="form-control" id="setting-input-3"
                          name="email" placeholder="Email" value="{{ $employee->email}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="setting-input-3"
                          name="phone" placeholder="entrez le contact"value="{{ $employee->contact}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="setting-input-3"
                          name="montant_journalier" placeholder="entrez le montant journalier" value="{{ $employee->montant_journalier}}">
                    </div>
